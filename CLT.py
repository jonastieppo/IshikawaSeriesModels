...
def Eight_harness_experimental_CLT():
    ...
    step = 0.045
    z_info1 = z_info(-2*step,-step)
    z_info2 = z_info(-step,0)
    z_info3 = z_info(0,step)
    z_info4 = z_info(step,2*step)
...
def ABD_from_homogenization(Eng):
    '''
    Some explanation
    '''
    # E_glass_epoxy_75 = {'E1':55.7E3,
    ...
    # homogenized_lamina = Homogeneous_lamina(E_glass_epoxy_75,Epoxy,vf=E_glass_epoxy_75['vf'])
    Qbar_0 = Qbar(0,EngineeringConstants=Eng)
    Qbar_90 = Qbar(90,EngineeringConstants=Eng)
...
def GeneralOrtho():
    ...
    homogenized_lamina = Homogeneous_lamina(E_glass_epoxy_75,Epoxy,vf=E_glass_epoxy_75['vf'])
    Qbar_0 = Qbar(23,EngineeringConstants=homogenized_lamina)
    # Qbar_90 = Qbar(90,EngineeringConstants=homogenized_lamina)
